...
@section('template_title') Edit Office Page
@endsection 
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                @endif
                {{ Form::open(array('route' => 'officeposts.store')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
                     <!--   <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Title" name="title" type="text" id="title" value="{{$officepost->title}}">
                        </div>

                        <div class="form-group">
                            <label for="body">Content</label>
                            <textarea class="form-control" placeholder="Content" id="summernote" name="body" cols="50" rows="10" style="display: none;">{!! $officepost->body !!}</textarea>
                        ...
                        {{Form::close()}}
                        <script>
                            var content = <?php print_r(json_encode($officepost->body)) ?>;
